...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Designed and implemented a new storage system for nearly all their app's data, enabling customers to store >10x larger documents, with better performance
\item Built infrastructure for crafting and running evaluations of computer use agents
\end{tightemize}
\sectionsep
